...
[![oo-ds-test](https://snapcraft.io/oo-ds-test/badge.svg)](https://snapcraft.io/oo-ds-test)
...
```
# snap set oo-ds-test onlyoffice.ds-port=8888
```
...
```
# snap set oo-ds-test onlyoffice.db-port=3307
```
...
```
# cp onlyoffice.key /var/snap/oo-ds-test/current/var/www/onlyoffice/Data/certs/
# cp onlyoffice.crt /var/snap/oo-ds-test/current/var/www/onlyoffice/Data/certs/
# cp dhparam.pem /var/snap/oo-ds-test/current/var/www/onlyoffice/Data/certs/
```

Then you must restart ONLYOFFICE Document Server to work on ssl, run:

```
# snap restart oo-ds-test
```
...
```
# rm /var/snap/oo-ds-test/current/var/www/onlyoffice/Data/certs/onlyoffice.*
# rm /var/snap/oo-ds-test/current/var/www/onlyoffice/Data/certs/dhparam.pem
# snap restart oo-ds-test
```
...
```
# snap set oo-ds-test onlyoffice.ds-ssl-port=444
```
...
```
# snap set oo-ds-test onlyoffice.key=value
```
...
```
# snap set oo-ds-test onlyoffice.example-enabled=true
```
